...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"docs_content":                operation_setting.GetGeneralSetting().DocsContent,
		"aff_commission_rate":         common.AffCommissionRate,
		"aff_commission_expire_days":  common.AffCommissionExpireDays,
